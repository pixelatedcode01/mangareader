...
MdFilledTonalButton.styles = [styles$i, styles$j, styles$g];
...
MdElevatedButton.styles = [styles$i, styles$j, styles$f];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$c = i$4`@media(forced-colors: active){.fab{border:1px solid ButtonText}.fab.extended{padding-inline-start:15px;padding-inline-end:19px}md-focus-ring{--md-focus-ring-outward-offset: 3px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdFab.styles = [styles$b, styles$d, styles$c];
MdFab = __decorate([
    t$3('md-fab')
], MdFab);
...
MdFilledField.styles = [styles$7, styles$2];
...
MdFilledTextField.styles = [styles$4, styles, styles$1];
...
document.querySelector('.previous p').textContent = `Chapter ${chapter}`
document.querySelector('.previous .button').setAttribute('data-value', chapter)
goToChapter(document.querySelector('.previous .button'))
